...
public class Runner extends TestCase{
	   ...
	   public static void main(String args[]) throws IOException {
			...
			//le damos formato
			 panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS)); 
				...
				// Se le asigna una posición dentro del Jpanel 
				 ...
				 //en este for recorremos el arrego de prueba para crear los radio button con los
				  // nonbres de los TC
			...
			//este for recorre el arreglo de los radio buttons para checar quien fue seleccionado
